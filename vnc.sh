#!/bin/sh
mkdir ngrok;cd ngrok;rm * ;rm -r *;wget 'https://bin.equinox.io/c/4VmDzA7iaHb/ngrok-stable-linux-amd64.zip';unzip ngrok-stable-linux-amd64.zip;read -p "Ingrese su token Ngrok: " input_token
